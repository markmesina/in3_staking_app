...
contract NodeRegistryLogic {
        ...
        external
    {
        ...
        if (_additionalDeposit > 0) {
            DappToken supportedToken = nodeRegistryData.supportedToken();
    ...
    function supportedToken() external view returns (DappToken) {
        ...
        internal
    {
        ...
        DappToken supportedERC20Token = nodeRegistryData.supportedToken();
